          ...
          >
            <div className="flex items-start justify-between gap-8">
                ...
                {featuredArticle.perspectives && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 pt-4 border-t border-stone-100">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-stone-600 font-light leading-relaxed">{featuredArticle.perspectives.for}</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-xs font-medium text-amber-700 uppercase tracking-wide">Unbiased</h4>
                      <p className="text-sm text-stone-600 font-light leading-relaxed">{featuredArticle.perspectives.neutral}</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-xs font-medium text-emerald-700 uppercase tracking-wide">Against</h4>
                      <p className="text-sm text-stone-600 font-light leading-relaxed">{featuredArticle.perspectives.against}</p>
                    </div>
                  </div>
                )}

                <div className="flex items-center gap-4 text-sm text-stone-500 font-light pt-2">
                  <span className="text-stone-700">{featuredArticle.source}</span>
              ...
              <div className="flex-shrink-0">
                <BiasGauge bias={featuredArticle.biasPercentage} size="small" />
              </div>
            </div>
          </Link>
        )}
